...
clustering of the variables into islands of multicollinearity. Based on the
correlation matrix (Supplementary Figure 1) we created 5 centers by _k_-means
clustering. To inspect the finer-grained patterns in dendrogram form, we 
performed hierarchical clustering with complete linkage 

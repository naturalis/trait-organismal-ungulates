...
#Temperature
Multiple variables are tightly correlated because they are aspects of temperature, the next step is to remove these variables 1 by 1 in order of decreasing VIF
```{}

...
setPredictors <- cbind(columns$X5.1_AdultBodyMass_g, plotPredictors)
...
vif(setPredictors)
setPredictors$AVGFoodConsumption <- NULL

# Round2 - Results: remove bio18
vif(setPredictors)
setPredictors$bio18 <- NULL

# Round3 - Results: all VIFs under 10 (except X5.1_AdultBodyMass_g)
vif(setPredictors)
```
...
# X5.1_AdultBodyMass_g, X1.1_ActivityCycle, X6.1_DietBreadth, X12.1_HabitatBreadth, X15.1_LitterSize, 
# X21.1_PopulationDensity_n_km2, X10.2_SocialGrpSize, Sociality, NumMales, MatingSystem, 
# YearRoundBreeding, DevelopmentStrategy, Horns_Antlers, Lifespan, NaturalPredators, AVGMovingSpeed, 
# AVGTravelDistance, Aspect, ClayPercentage, OrganicCarbon

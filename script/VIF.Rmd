...
findCorrelation(matrix, cutoff = 0.9, verbose = TRUE, exact=TRUE)
```

Flagging aka removing: 
  Column 69: bio17
  Column 65: bio13
  Column 64: bio12
  Column 63: bio11
  ...
  Column 56: bio4
  Column 53: bio1
  Column 49: thermicityIndex
  Column 44: PETColdestQuarter
  Column 41: maxTempColdest
  Column 40: growingDegDays5
  Column 39: growingDegDays0
  Column 38: embergerQ
  Column 37: continentality
  Column 34: annualPET
  Column 30: AVGTravelDistance
  Column 28: CarryWeight
  Column 2: X5.1_AdultBodyMass_g

```{r remove flagged columns}
testdata <- columns[,c(1, 3:27, 29, 31:33, 35, 36, 42, 43, 45:48, 50:52, 54, 55, 60, 66:68, 70, 71)]

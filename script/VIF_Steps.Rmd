...
The OMI and trait datasets are combined and the VIF values above 10 are removed. AdultBodyMass is a very
important trait to keep in this research, so this one is kept in the dataset.
...
# Round 1: Removed PETDriestQuarter(51)
vif(dataset[,c(7, 8, 11, 13, 14, 16, 18, 20, 26, 27, 30:33, 37:39, 52)])

# Round 2: Removed Lifespan(32)
vif(dataset[,c(7, 8, 11, 13, 14, 16, 18, 20, 26, 27, 30, 31, 33, 37:39, 52)])
```


## Final predictors

The final set of predictors is found, and contains the following traits:
X1.1_ActivityCycle, X5.1_AdultBodyMass_g, X6.1_DietBreadth, X12.1_HabitatBreadth, X22.1_HomeRange_km2,
X15.1_LitterSize, X21.1_PopulationDensity_n_km2, X10.2_SocialGrpSize, SocialHierarchy, NumMales, 
DevelopmentStrategy, Horns_Antlers, NaturalPredators, Aspect, BulkDensity, ClayPercentage, PETseasonality

``` {r predictors}
predictors <- dataset[,c(7, 8, 11, 13, 14, 16, 18, 20, 26, 27, 30, 31, 33, 37:39, 52)]
```
